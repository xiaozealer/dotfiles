...
-- NOTE: the statusline is owned by lualine (see plugins/lualine.lua). The
-- previous hand-rolled statusline here (git_branch/lsp_status/formatter_status
-- + vim.opt.statusline) was always overridden by lualine on startup, so it was
